...
```{r lg-winner-map, fig.height=5,fig.cap="Winner of MA Lt. Governor Democratic Primary"}
#| column: page
lg_winner_map <- (
    tm_shape(city_town) +
    tm_fill(col="winner",
...
```{r lg-winner-distance-map, fig.height=5,fig.cap="Winner of MA Lt. Governor Democratic Primary w/distances"}
#| column: page
lg_winner_dist_map <- (
    tm_shape(city_town) +
    tm_fill(col="winner",
...
```{r lg-driscoll-map, fig.height=5,fig.cap="Kim Driscoll vote share MA Lt. Governor Democractic Primary"}
#| column: page
lg_driscoll_map <- (
    tm_shape(city_town) +
...
```{r lg-lesser-map, fig.height=5,fig.cap="Eric Lesser vote share MA Lt. Governor Democractic Primary"}
#| column: page
lg_lesser_map <- (
    tm_shape(city_town) +
...
```{r lg-gouveia-map, fig.height=5,fig.cap="Tami Gouveia vote share MA Lt. Governor Democractic Primary"}
#| column: page
lg_gouveia_map <- (
    tm_shape(city_town) +
