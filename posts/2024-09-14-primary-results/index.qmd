...
office_primary_map(
    "Governor's Council",
    read_sf("https://raw.githubusercontent.com/bwbensonjr/mapoli/refs/heads/master/gis/geojson/govcouncil2021.geojson"),
    map_districts
)
```
...
office_primary_map(
    "State Senate",
    read_sf("https://raw.githubusercontent.com/bwbensonjr/mapoli/refs/heads/master/gis/geojson/senate2021.geojson"),
    map_districts
)
```
...
office_primary_map(
    "State Representative",
    read_sf("https://raw.githubusercontent.com/bwbensonjr/mapoli/refs/heads/master/gis/geojson/house2021.geojson"),
    map_districts
)
```
