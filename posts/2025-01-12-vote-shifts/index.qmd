...
state_reps <- read_csv("https://bwbensonjr.github.io/ma-election-db/data/ma_general_election_summaries.csv.gz") |>
    filter(election_date == "2024-11-05", office == "State Representative") |>
    select(district, Representative=display_winner)

elec_summaries <- read_csv("https://bwbensonjr.github.io/ma-election-db/data/ma_general_election_summaries.csv.gz")

pres_results <- read_csv("https://raw.githubusercontent.com/bwbensonjr/mapoli/refs/heads/master/pvi/ma_state_rep_pres_pvi_2024.csv") |>
    rename(district = State_Rep)

demos <- read_csv("https://raw.githubusercontent.com/bwbensonjr/mapoli/refs/heads/master/demographics/data/ma_state_rep_demographics.csv") |>
...
dist_geom <- read_sf("https://raw.githubusercontent.com/bwbensonjr/mapoli/refs/heads/master/gis/geojson/house2021.geojson") |>
    left_join(pres_demos, by="district")
```

```{r, fig.height=5, fig.cap="An overview of vote shifts by State Rep. district with red indicating shifts towards Trump and blue towards Democratic presidential candidates."}
#| column: body-outset
...
```{r, fig.height=6, fig.cap="Factors associated with vote shift. Lines sloping downward indicate shifts are towards Trump and upward sloping lines are shifts toward Democrats."}
#| column: body-outset
