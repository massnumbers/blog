...
election of a canidate of choice by that minority group.
...
sen_3_map <- senate_map(sen_3, (sen_pcts_3 %>% filter(Ward != "1")))
...
variables ends up explaining 90 percent of the variation in the margin
of the 2020 Hampden District Democratic primary vote. Hispanic voters
were much more likely to vote for Gomez, with knowing about Gomez as a
Springfield voter also playing a factor.
...
The new First Essex State Senate District contains all of Lawrence,
all of Methuen, and approximately 5 precincts of Haverhill (give or
take a few census blocks). The previous lines of the district did not
include Lawrence and instead included a large number of largely white
surrounding communities. The new lines result in a voting age
population that is 36% White, 56% Hispanic, 10% Black, and 3%
Asian. There is an almost 10 point difference when looking at Hispanic
citizen voting age population, showing the large assimilation of
immigrants, and somewhat limiting voting power. 
...
Suffolk District featuring Miniard Culpepper, Nika Elugardo, James
Grant, Liz Miranda, and Dianne Wilkerson.
