---
title: "Swing district special election results in a close Democratic win"
description: |
  Democrat Lisa Field wins special election to replace Carol Doherty by 24 votes
author: Brent Benson
date: 2025-06-12
citation: false  
...
```{r post-meta}
meta() %>%
    meta_description("Democrat Lisa Field wins special election to replace Carol Doherty by 24 votes") |>
    meta_viewport() |>
    meta_social(
        title = "Swing district special election results in close Democratic win",
...
Swing districts don't swing every election, but the 24 vote margin in
...
Lisa Field, the Democratic candidate from Taunton emerged with a 24
vote margin based on the unofficial results posted by Easton and
Taunton election officials. Lawrence Quintal, the Republican candidate
from Taunton, has said that he will request a recount which is not
...
organization of the recount.

The special election was the result of the passing of Representative
Carol Doherty (D-Taunton) who died in February from pancreatic
cancer. Lisa Field is a lobbyist for the Massachusetts Nurses
Association and Lawrence Quintal is the co-owner of Silva Funeral Home
and a Taunton City Councilor.
...
precincts created a 48 vote margin for Lawrence Quintal. Quintal had
more votes than Field in seven precincts; Field had more votes in five
precincts; and the candidates were tied with 50 votes each in Taunton
Ward 4, Precinct A.
