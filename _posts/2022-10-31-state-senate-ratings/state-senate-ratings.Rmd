...
model. We can also generate a 90% onfidence interval for the voting
result with the Democratic percentage varying from 41% to 63%&mdash;a
wide enough interval to allow for a comfortable GOP win, or a large
