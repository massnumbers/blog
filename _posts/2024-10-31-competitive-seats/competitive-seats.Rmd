...
The five elections that look the most competitive all feature
Republican incumbents in districts that have PVIs between D+1 and D+6,
which puts them in a more competitive position in presidential
election years. The remaining three districts are open seats which
lean slightly Republican with PVIs R+1 or R+2.
